...
show_kube() {
  local index icon color text background context_color namespace_color symbol_enabled module
  ...
  background=$(get_tmux_batch_option "@catppuccin_kube_background" "$thm_gray")
